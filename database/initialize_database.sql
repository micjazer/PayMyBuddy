...
CREATE TABLE IF NOT EXISTS `paymybuddy`.`ACCOUNT_ID` (
  ...
  CONSTRAINT `fk_ACCOUNT_ID_USER_ACCOUNT`
    FOREIGN KEY (`user_account_id`)
    REFERENCES `paymybuddy`.`USER_ACCOUNT` (`USER_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ACCOUNT_ID_BANK_ACCOUNT`
...
CREATE TABLE IF NOT EXISTS `paymybuddy`.`TRANSACTION` (
  ...
  CONSTRAINT `fk_RELATION_ACCOUNT_ID_receiver_id`
    FOREIGN KEY (`receiver_id`)
    REFERENCES `paymybuddy`.`ACCOUNT_ID` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_RELATION_ACCOUNT_ID_sender_id`
